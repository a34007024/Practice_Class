...
{	char i;						// 宣告變數 
	while(1)					// 無窮盡迴圈 
	{	for(i=0;i<16;i++)		// 呼叫掃瞄函數64次 
			display(15-i);			// 約16ms*64=0.5s
	}
}
//=== 八位掃瞄函數 ===
void	display(char x)	
